...
USE `Kodi_U01_Video_119`;
  ...
  RENAME TABLE `files` TO `global_files`;
    -- USER 01 --
    ALTER TABLE `global_files` CHANGE playCount playCount_U01 int;
    ALTER TABLE `global_files` CHANGE lastPlayed lastPlayed_U01 text;
    -- USER 02 --
    ALTER TABLE `global_files` ADD playCount_U02 int AFTER lastPlayed_U01;
    ALTER TABLE `global_files` ADD lastPlayed_U02 text AFTER playCount_U02;
    -- USER 03 --
    ALTER TABLE `global_files` ADD playCount_U03 int AFTER lastPlayed_U02;
    ALTER TABLE `global_files` ADD lastPlayed_U03 text AFTER playCount_U03;
    -- USER 04 --
    ALTER TABLE `global_files` ADD playCount_U04 int AFTER lastPlayed_U03;
    ALTER TABLE `global_files` ADD lastPlayed_U04 text AFTER playCount_U04;
    -- USER 05 --
    ALTER TABLE `global_files` ADD playCount_U05 int AFTER lastPlayed_U04;
    ALTER TABLE `global_files` ADD lastPlayed_U05 text AFTER playCount_U05;
    -- USER 06 --
    ALTER TABLE `global_files` ADD playCount_U06 int AFTER lastPlayed_U05;
    ALTER TABLE `global_files` ADD lastPlayed_U06 text AFTER playCount_U06;
    -- USER 07 --
    ALTER TABLE `global_files` ADD playCount_U07 int AFTER lastPlayed_U06;
    ALTER TABLE `global_files` ADD lastPlayed_U07 text AFTER playCount_U07;
    -- USER 08 --
    ALTER TABLE `global_files` ADD playCount_U08 int AFTER lastPlayed_U07;
    ALTER TABLE `global_files` ADD lastPlayed_U08 text AFTER playCount_U08;
    -- USER 09 --
    ALTER TABLE `global_files` ADD playCount_U09 int AFTER lastPlayed_U08;
  ...
  RENAME TABLE `episode` TO `global_episode`;
    -- USER 01 --
    ALTER TABLE `global_episode` CHANGE userrating userrating_U01 int;
    -- USER 02 --
    ALTER TABLE `global_episode` ADD userrating_U02 int AFTER userrating_U01;
    -- USER 03 --
    ALTER TABLE `global_episode` ADD userrating_U03 int AFTER userrating_U02;
    -- USER 04 --
    ALTER TABLE `global_episode` ADD userrating_U04 int AFTER userrating_U03;
    -- USER 05 --
    ALTER TABLE `global_episode` ADD userrating_U05 int AFTER userrating_U04;
    -- USER 06 --
    ALTER TABLE `global_episode` ADD userrating_U06 int AFTER userrating_U05;
    -- USER 07 --
    ALTER TABLE `global_episode` ADD userrating_U07 int AFTER userrating_U06;
    -- USER 08 --
    ALTER TABLE `global_episode` ADD userrating_U08 int AFTER userrating_U07;
    -- USER 09 --
    ALTER TABLE `global_episode` ADD userrating_U09 int AFTER userrating_U08;
  ...
  RENAME TABLE `seasons` TO `global_seasons`;
    -- USER 01 --
    ALTER TABLE `global_seasons` CHANGE userrating userrating_U01 int;
    -- USER 02 --
    ALTER TABLE `global_seasons` ADD userrating_U02 int AFTER userrating_U01;
    -- USER 03 --
    ALTER TABLE `global_seasons` ADD userrating_U03 int AFTER userrating_U02;
    -- USER 04 --
    ALTER TABLE `global_seasons` ADD userrating_U04 int AFTER userrating_U03;
    -- USER 05 --
    ALTER TABLE `global_seasons` ADD userrating_U05 int AFTER userrating_U04;
    -- USER 06 --
    ALTER TABLE `global_seasons` ADD userrating_U06 int AFTER userrating_U05;
    -- USER 07 --
    ALTER TABLE `global_seasons` ADD userrating_U07 int AFTER userrating_U06;
    -- USER 08 --
    ALTER TABLE `global_seasons` ADD userrating_U08 int AFTER userrating_U07;
    -- USER 09 --
    ALTER TABLE `global_seasons` ADD userrating_U09 int AFTER userrating_U08;
  ...
  RENAME TABLE `tvshow` TO `global_tvshow`;
    -- USER 01 --
    ALTER TABLE `global_tvshow` CHANGE userrating userrating_U01 int;
    -- USER 02 --
    ALTER TABLE `global_tvshow` ADD userrating_U02 int AFTER userrating_U01;
    -- USER 03 --
    ALTER TABLE `global_tvshow` ADD userrating_U03 int AFTER userrating_U02;
    -- USER 04 --
    ALTER TABLE `global_tvshow` ADD userrating_U04 int AFTER userrating_U03;
    -- USER 05 --
    ALTER TABLE `global_tvshow` ADD userrating_U05 int AFTER userrating_U04;
    -- USER 06 --
    ALTER TABLE `global_tvshow` ADD userrating_U06 int AFTER userrating_U05;
    -- USER 07 --
    ALTER TABLE `global_tvshow` ADD userrating_U07 int AFTER userrating_U06;
    -- USER 08 --
    ALTER TABLE `global_tvshow` ADD userrating_U08 int AFTER userrating_U07;
    -- USER 09 --
    ALTER TABLE `global_tvshow` ADD userrating_U09 int AFTER userrating_U08;
    -- TVSHOW VIEW FOR U01 --
  ...
  -- GLOBAL MOVIE --
    ...
    -- USER 01 --
    ALTER TABLE `global_movie` CHANGE userrating userrating_U01 int;
    -- USER 02 --
    ALTER TABLE `global_movie` ADD userrating_U02 int AFTER userrating_U01;
    -- USER 03 --
    ALTER TABLE `global_movie` ADD userrating_U03 int AFTER userrating_U02;
    -- USER 04 --
    ALTER TABLE `global_movie` ADD userrating_U04 int AFTER userrating_U03;
    -- USER 05 --
    ALTER TABLE `global_movie` ADD userrating_U05 int AFTER userrating_U04;
    -- USER 06 --
    ALTER TABLE `global_movie` ADD userrating_U06 int AFTER userrating_U05;
    -- USER 07 --
    ALTER TABLE `global_movie` ADD userrating_U07 int AFTER userrating_U06;
    -- USER 08 --
    ALTER TABLE `global_movie` ADD userrating_U08 int AFTER userrating_U07;
    -- USER 09 --
    ALTER TABLE `global_movie` ADD userrating_U09 int AFTER userrating_U08;
    -- MOVIE VIEW FOR U01 --
